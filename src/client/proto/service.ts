...
function createBaseSolutionRoute(): SolutionRoute {
  return { points: [], distance: 0, time: 0, isLooped: false, isPenalized: false };
}

export const SolutionRoute = {
  encode(message: SolutionRoute, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.points) {
      writer.uint32(10).string(v!);
    }
    if (message.distance !== 0) {
    ...
    if (message.isLooped !== false) {
      writer.uint32(32).bool(message.isLooped);
    }
    if (message.isPenalized !== false) {
      writer.uint32(40).bool(message.isPenalized);
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): SolutionRoute {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseSolutionRoute();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
        ...
        case 5:
          ...
          message.isPenalized = reader.bool();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): SolutionRoute {
    return {
      points: globalThis.Array.isArray(object?.points) ? object.points.map((e: any) => globalThis.String(e)) : [],
      distance: isSet(object.distance) ? globalThis.Number(object.distance) : 0,
      time: isSet(object.time) ? globalThis.Number(object.time) : 0,
      isLooped: isSet(object.isLooped) ? globalThis.Boolean(object.isLooped) : false,
      isPenalized: isSet(object.isPenalized) ? globalThis.Boolean(object.isPenalized) : false,
    };
  },

  toJSON(message: SolutionRoute): unknown {
    const obj: any = {};
    if (message.points?.length) {
      obj.points = message.points;
    }
    ...
    if (message.isLooped !== false) {
      obj.isLooped = message.isLooped;
    }
    if (message.isPenalized !== false) {
      obj.isPenalized = message.isPenalized;
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<SolutionRoute>, I>>(base?: I): SolutionRoute {
    return SolutionRoute.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SolutionRoute>, I>>(object: I): SolutionRoute {
    const message = createBaseSolutionRoute();
    message.points = object.points?.map((e) => e) || [];
    message.distance = object.distance ?? 0;
    message.time = object.time ?? 0;
    message.isLooped = object.isLooped ?? false;
    message.isPenalized = object.isPenalized ?? false;
    return message;
  },
};
...
export const Solution = {
  encode(message: Solution, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.routes) {
      SolutionRoute.encode(v!, writer.uint32(18).fork()).ldelim();
    }
    if (message.distance !== 0) {
      writer.uint32(25).double(message.distance);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.routes.push(SolutionRoute.decode(reader, reader.uint32()));
          continue;
        case 3:
          if (tag !== 25) {
            break;
  ...
  fromJSON(object: any): Solution {
    return {
      id: isSet(object.id) ? globalThis.String(object.id) : "",
      routes: globalThis.Array.isArray(object?.routes) ? object.routes.map((e: any) => SolutionRoute.fromJSON(e)) : [],
      distance: isSet(object.distance) ? globalThis.Number(object.distance) : 0,
      time: isSet(object.time) ? globalThis.Number(object.time) : 0,
  ...
  toJSON(message: Solution): unknown {
    ...
    if (message.routes?.length) {
      obj.routes = message.routes.map((e) => SolutionRoute.toJSON(e));
    }
    if (message.distance !== 0) {
      obj.distance = message.distance;
    }
  ...
  fromPartial<I extends Exact<DeepPartial<Solution>, I>>(object: I): Solution {
    const message = createBaseSolution();
    message.id = object.id ?? "";
    message.routes = object.routes?.map((e) => SolutionRoute.fromPartial(e)) || [];
    message.distance = object.distance ?? 0;
    message.time = object.time ?? 0;
